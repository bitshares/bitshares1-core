...
void compile_genesis_block_to_source(const fc::path& source_file_name, const fc::path& genesis_block_file_name)
{
  ...
  source_file << "#include <bts/client/genesis_json.hpp>\n";
  source_file << "#include <string>\n\n";
  source_file << "namespace bts { namespace client {\n\n";
  ...
  source_file << "std::istringstream get_builtin_genesis_json_stream()\n";
  source_file << "{\n";
  ...
  source_file << "  return std::istringstream(result.str());\n";
  source_file << "}\n\n";
  source_file << "} } // end namespace bts::client\n";
}
