#include <bts/import_electrum_wallet.hpp>
...
BOOST_FUSION_ADAPT_STRUCT(bts::python_dict_type_t,
              (std::vector<bts::python_dict_elem_type_t>, items))

BOOST_FUSION_ADAPT_STRUCT(bts::python_dict_array_type_t,
              (std::vector<bts::python_dict_val_t>, items))
...
namespace bts {
   ...
   private:
      ...
      qi::ru
le<It, std::vector<python_dict_elem_type_t>(), ascii::space_type> pairs;
   ...
   private:
      ...
      bts::python_dict_type_t accounts;
