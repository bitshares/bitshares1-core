...
namespace bts { namespace wallet {
  ...
  fc::ecc::public_key extended_private_key::get_public_key()const
  {
   ...
   { try {
      ...
      uint32_t checksum = 0;
      std::vector<char> data = fc::from_base58( base58str );
...
namespace fc 
{ 
   void to_variant( const bts::wallet::extended_address& ext_addr,  fc::variant& vo )
   {
   ...
   {
      vo = bts::wallet::extended_address( var.as_string() );
   }
}
