...
"text" (string) The help text
    ...
    fc::variant rpc_server_impl::help(const fc::variants& params)
    {
      ...
      { //display detailed description of requested command
        ...
        {
          bts::api::method_data method_data = itr->second;
...
Wallets exist in the wallet data directory.
    ...
    static bts::api::method_data wallet_list_sending_accounts_metadata{"wallet_list_sending_accounts", nullptr,
            /* description */ "Lists all foreign addresses and their labels associated with this wallet",
            /* returns: */    "map<string,extended_address>",
            /* params:          name     type    classification                   default value */
                              {{"start", "int",  bts::api::optional_positional, 0},
    ...
    static bts::api::method_data wallet_reserve_name_metadata{"wallet_reserve_name", nullptr,
    ...
    static bts::api::method_data wallet_register_delegate_metadata{"wallet_register_delegate", nullptr,
            /* description */ "Registers a delegate to be voted upon by shareholders",
            /* returns: */    "name_record",
            /* params:          name          type       classification                   default_value */
                              {{"name",       "string",  bts::api::required_positional, fc::ovariant()},
                               {"data",       "variant", bts::api::required_positional, fc::ovariant()}},
            /* prerequisites */ bts::api::json_authenticated | bts::api::wallet_open | bts::api::wallet_unlocked | bts::api::connected_to_network,
          R"(
     )" };
