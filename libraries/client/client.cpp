                           ...
                           public bts::api::common_api
       {
          public:
            ...
            client_impl(bts::client::client* self) : 
              ...
              _last_recorded_connection_count(0),
            ...
            uint32_t                                                _last_recorded_connection_count;
      ...
      */
                                                                              ...
                                                                              uint32_t number_of_blocks_after_reference_point /* = 0 */)
      {
       ...
       void client_impl::connection_count_changed(uint32_t new_connection_count)
       {
         ...
         ulog( message.str() );
         if (_notifier &&
             new_connection_count < _connection_count_notification_threshold && 
             _last_recorded_connection_count >= _connection_count_notification_threshold)
           _notifier->connection_count_dropped_below_threshold(new_connection_count, _connection_count_notification_threshold);
         _last_recorded_connection_count = new_connection_count;
       }
