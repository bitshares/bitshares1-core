...
namespace bts { namespace client {
    ...
    class client
    {
       public:
          ...
          */
         transaction_id_type wallet_reserve_name( const std::string& name, const fc::variant& json_data );
         transaction_id_type wallet_update_name( const std::string& name,
                                                 const fc::optional<fc::variant>& json_data); //TODO
         transaction_id_type wallet_register_delegate(const std::string& name, const fc::variant& json_data);
