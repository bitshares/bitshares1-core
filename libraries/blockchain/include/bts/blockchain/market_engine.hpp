...
namespace bts { namespace blockchain { namespace detail {
  ...
  public:
    ...
    static asset get_interest_paid_v2(const asset& total_amount_paid, const price& apr, uint32_t age_seconds);
    static asset get_interest_owed_v2(const asset& principle, const price& apr, uint32_t age_seconds);
