...
#define BTS_BLOCKCHAIN_DATABASE_VERSION                     135
...
#define BTS_BLOCKCHAIN_MIN_INTEREST_PERIOD_SEC              (60*60*24) // 24 hours
 ...
 */
#define BTS_BLOCKCHAIN_MARKET_DEPTH_REQUIREMENT             (BTS_BLOCKCHAIN_INITIAL_SHARES/400)
