...
#define BTS_BLOCKCHAIN_INITIAL_SHARES     (4000000*BTS_BLOCKCHAIN_SHARE)
...
#define BTS_BLOCKCHAIN_MIN_FEE            (BTS_BLOCKCHAIN_INITIAL_SHARES/400)/BTS_BLOCKCHAIN_BLOCKS_PER_YEAR
