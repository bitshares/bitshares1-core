...
#define BTS_BLOCKCHAIN_MIN_FEEDS                            (BTS_BLOCKCHAIN_NUM_DELEGATES/32)
 ...
 */
#define BTS_BLOCKCHAIN_MARKET_DEPTH_REQUIREMENT             (10) //(BTS_BLOCKCHAIN_INITIAL_SHARES/1000000000)
