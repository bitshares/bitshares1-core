...
namespace bts { namespace blockchain {
   ...
   class pow_validator
   {
      public:
        ...
        virtual bool              validate_work( const block_header& header, uint64_t valid_miner_votes = 0 );
   ...
   class sim_pow_validator : public pow_validator
   {
      public:
        ...
        virtual bool              validate_work( const block_header& header, uint64_t valid_miner_votes = 0) { return true; }
