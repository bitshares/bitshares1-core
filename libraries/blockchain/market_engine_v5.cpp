...
namespace bts { namespace blockchain { namespace detail {
          ...
          while( get_next_bid() && get_next_ask() )
          {
            ...
            if( _current_ask->type == cover_order && _current_bid->type == short_order )
            {
                ...
                */
                ...
                if( _current_bid->state.limit_price.valid() )
                {
                  ...
                  mtrx.bid_index.order_price = *_current_bid->state.limit_price;
                }
            ...
            else if( _current_ask->type == cover_order && _current_bid->type == bid_order )
            {
                ...
                */
                ...
                const asset max_usd_purchase = asset( *_current_ask->collateral, _base_id ) * mtrx.bid_index.order_price;
  ...
  /**
    ...
    */
void market_engine_v5::update_market_history( const asset& base_volume,
